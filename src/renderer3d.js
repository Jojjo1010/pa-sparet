        ...
        case 3: { // FIGHTING
          ...
          if (!fighting && !b.targetSlot?.autoWeaponId) {
            ...
            for (let i = 0; i < 6; i++) {
              ...
              ctx.beginPath();
              ctx.arc(px, py, 3 * this.Z, 0, Math.PI * 2);
            ...
            if (b.stealFlash > 0) {
              ...
              ctx.lineWidth = 3;
              ctx.font = `bold ${16 * this.Z}px monospace`;
              ctx.textAlign = 'center';
              ctx.strokeText(`-${b.totalStolen}g`, sx, sy - 40 * this.Z);
              ctx.fillStyle = `rgba(231, 76, 60, ${Math.min(1, b.stealFlash * 2)})`;
              ctx.fillText(`-${b.totalStolen}g`, sx, sy - 40 * this.Z);
            }
          ...
          if (!fighting && b.targetSlot?.autoWeaponId) {
            ...
            const glowR = (22 + Math.sin(performance.now() * 0.01) * 4) * this.Z;
            ctx.beginPath();
            ...
            ctx.lineCap = 'round';
            ctx.beginPath();
            ctx.moveTo(sx - 14 * this.Z, sy - 14 * this.Z); ctx.lineTo(sx + 14 * this.Z, sy + 14 * this.Z);
            ctx.moveTo(sx + 14 * this.Z, sy - 14 * this.Z); ctx.lineTo(sx - 14 * this.Z, sy + 14 * this.Z);
            ctx.stroke();
            ctx.lineCap = 'butt';
            // DISABLED label
            ...
            ctx.textAlign = 'center';
            ctx.strokeText('DISABLED!', sx, sy - 24 * this.Z);
            ctx.fillStyle = '#ff4444';
            ctx.fillText('DISABLED!', sx, sy - 24 * this.Z);
          }
